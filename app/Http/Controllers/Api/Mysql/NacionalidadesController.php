...
use App\Api\Entities\Mysql\Nacionalidades as Model;
use App\Api\Transformers\NacionalidadesTransformer as Transformer;
use JuaGuz\ApiGenerator\Api;


class NacionalidadesController extends Api
{
    protected $model;
