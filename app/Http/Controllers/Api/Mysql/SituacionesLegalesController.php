...
use App\Api\Entities\Mysql\SituacionesLegales as Model;
use App\Api\Transformers\SituacionesLegalesTransformer as Transformer;
use JuaGuz\ApiGenerator\Api;


class SituacionesLegalesController extends Api
{
    protected $model;
