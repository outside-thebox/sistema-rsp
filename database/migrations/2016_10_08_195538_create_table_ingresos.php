...
class CreateTableIngresos extends Migration
{
    ...
    public function up()
    {
        Schema::create('ingresos', function (Blueprint $table) {
            ...
            $table->integer('tipo_documento_declarado_id')->unsigned();
            ...
            $table->integer('tipo_documento_real_id')->unsigned();
            ...
            $table->integer('profesiones_id')->unsigned();
            ...
            $table->integer('situacion_legal_id')->unsigned();
